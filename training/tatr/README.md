...
python3 main.py --data_type structure --config_file structure_config.json --data_root_dir ../final_dataset_26_sep_23/trash_train/clean_labels --epochs=2 --batch_size 2 --model_save_dir ../trainlogs/aug_23/kr
