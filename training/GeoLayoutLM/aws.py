...
def process_text_analysis(client, document):
...
def main():
    ...
    root_path = "/home/gayathri/Downloads/CS/ANNOTATED_CS/ANNOTATED_VALIDATED_278/Images"
    images_list = os.listdir(root_path)

    save_to = 'custom_data/test/key_val_sets'
    save_words_to = 'custom_data/test/all_words'
    ...
    for image_name in tqdm(images_list, desc="Reading key-val pairs"):
        ...
        document = os.path.join(root_path, image_name)
        block_count, key_val_pairs, all_words =process_text_analysis(client, document)
