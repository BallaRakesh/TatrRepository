    ...
    def _getitem_geo(self, idx):
        ...
        for class_name in self.class_names:
            ...
            for word_list in classes_dic[class_name]:
                ...
                # print(f"typeeeeeeeeeeeeeeeeeeeeeeeeeeeeee {word_list}, {type(word_list)}")
                # if not str(type(word_list)).endswith(" 'list'>"):
                #     # print(f"SKIPPING {word_list}")
                #     continue   # avoid training on wrongly cropped images
