...
class GeoLayoutLMModel(BrosPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        # torch.reshape(input_ids, (1,input_ids.shape))
        # input_ids = input_ids.unsqueeze(0)
        # attention_mask = attention_mask.unsqueeze(0)
        # bbox = bbox.unsqueeze(0)
        # image = image.unsqueeze(0)
        # bbox_4p_normalized = bbox_4p_normalized.unsqueeze(0)
        # attention_mask = attention_mask.unsqueeze(0)
        # first_token_idxes=first_token_idxes.unsqueeze(0)
        # first_token_idxes_mask=first_token_idxes_mask.unsqueeze(0)
